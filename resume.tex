...
\section{Projects}
    ...
    \resumeSubHeadingListStart
        \resumeProjectHeading
          {\textbf{\href{https://github.com/kyleung1/WebDevEvaluator/}{Web Dev Evaluator}} $|$ \emph{Next.js, React, Kotlin, Spring, Python}}{October 2022}
          \resumeItemListStart
...
\section{Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Technologies}{: SQL, NoSQL (Mongo, Redis), Bootstrap, Sass, Tailwind, React, Svelte, Vue, Next.js, Nuxt.js, Vite, Express, NodeJS, Flask, Markdown, ArcGIS, QGIS, Spring Boot, Cypress} \\
    }}
 \end{itemize}
 \vspace{-16pt}
